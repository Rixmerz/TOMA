...
console.error = noop;
async function main() {
    const server = new Server({ name: 'toma', version: '0.1.0' }, { capabilities: { tools: {} } });
        ...
        try {
            switch (name) {
                ...
                case 'tmux_capture_window': {
                    const sessionName = args?.session_name;
                    const windowIndex = args?.window_index;
                    const numLines = args?.num_lines || 50;
                ...
                case 'tmux_create_session': {
                    const sessionName = args?.session_name;
                    const startDirectory = args?.start_directory;
                ...
                case 'schedule_task': {
                    ...
                    const targetWindow = args?.target_window;
                    const pmSessionName = args?.pm_session_name;
                    const pmWindowIndex = args?.pm_window_index;
                ...
                case 'schedule_engineer_standup': {
                    const sessionName = args?.session_name;
                    const minutes = args?.minutes || 480;
                    const pmSessionName = args?.pm_session_name;
                    const pmWindowIndex = args?.pm_window_index;
                ...
                case 'send_message_between_engineers': {
                    const fromSession = args?.from_session;
                    const toSession = args?.to_session;
                    const message = args?.message;
                ...
                case 'broadcast_message': {
                    ...
                    const message = args?.message;
                    const excludeSession = args?.exclude_session;
